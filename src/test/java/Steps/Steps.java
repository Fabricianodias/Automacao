...
public class Steps {
	...
	public void selecione_o_botao_abrir_nova_conta() throws Throwable {
		m.pausa(5000, "pausa para abrir o botao abrir conta");
		click( e.getBtnfecharcokies(), "selecionar botão fechar cokies");
	...
	public void o_usuario_preencher_o_formulario() throws Throwable {
	    ...
	    m.preencher(e.getCampoCPF(), "05939970001", "Preenchendo o campo CPF");
